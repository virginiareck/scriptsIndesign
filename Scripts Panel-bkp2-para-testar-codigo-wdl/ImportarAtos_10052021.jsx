...
/*   alterei no interface para chamar esse importaratos quando converte para pdf,
parece ok o problema do pdf indo pra nova pagina
tentanto resolver problema de conversao odt 10-05-2021-virginia
*/
...
var regrasDOMSC = [
    ...
    ["", "-", 0], //2019-02-14 WIL
    ["J U S T I F I C A", "JUSTIFICA", 0], //2019-02-14 WIL
    ...
    ["E X T R A T O", "EXTRATO", 0], // 11-05-2018 WIL
    ["T E S T E M U N H A S", "TESTEMUNHAS", 0], // 11-05-2018 WIL
    ["C O M U N I Q U E – S E", "COMUNIQUE-SE", 0], // 11-05-2018 WIL
   ["=====",  "---------", 0]
    ...
    //todo: refazer usando grep
    ["0[^\\p][^\\p]PORTARI","PORTARI",0],
    ["1[^\\p][^\\p]PORTARI","PORTARI",0],
    ["2[^\\p][^\\p]PORTARI","PORTARI",0],
    ["3[^\\p][^\\p]PORTARI","PORTARI",0],
    ["4[^\\p][^\\p]PORTARI","PORTARI",0],
    ["5[^\\p][^\\p]PORTARI","PORTARI",0],
    ["7[^\\p][^\\p]PORTARI","PORTARI",0],
    ["6[^\\p][^\\p]PORTARI","PORTARI",0],
    ["8[^\\p][^\\p]PORTARI","PORTARI",0],
    ["9[^\\p][^\\p]PORTARI","PORTARI",0],
    ...
    ["ANTONIO JOSÉ BISSANI LILIAN BITTENCOURT CHÜLER[^\\p]Prefeito em Exercício Diretora Dpto Recursos Humanos", "ANTONIO JOSÉ BISSANI \rPrefeito em Exercício \r \rLILIAN BITTENCOURT CHÜLER \rDiretora Dpto Recursos Humanos", 0],  // 10-05-18 wil
    ["ANTONIO JOSÉ BISSANI LILIAN BITTENCOURT CHÜLER[^\\p]Prefeito em Exercício Diretora do Dpto Recursos Humanos", "ANTONIO JOSÉ BISSANI \rPrefeito em Exercício \r \rLILIAN BITTENCOURT CHÜLER \rDiretora Dpto Recursos Humanos", 0],   // 10-05-18 wil
    ["ANTONIO JOSÉ BISSANI LILIAN BITTENCOURT CHÜLER[^\\p]Prefeito Municipal Diretora do Dpto Recursos Humanos", "ANTONIO JOSÉ BISSANI \rPrefeito Municipal \r \rLILIAN BITTENCOURT CHÜLER \rDiretora Dpto Recursos Humanos", 0],   // 10-05-18 wil
    ["EVERALDO CAPISTRANO DA CUNHA SAULO STEIMBACH[^\\p]Prefeito Municipal Responsável Sec. Mun. Adm. e Fazenda", "EVERALDO CAPISTRANO DA CUNHA \rPrefeito Municipal \r \rSAULO STEIMBACH \rResponsável Sec. Mun. Adm. e Fazenda", 0],   // 10-09-19 wil

    ["VILMAR JOSÉ NECKEL MARIA MADALENA SILVEIRA[^\\p]Prefeito Municipal Responsável Sec. Mun. Administração e Fazenda", "VILMAR JOSÉ NECKEL \rPrefeito Municipal \r \rMARIA MADALENA SILVEIRA \rResponsável Sec. Mun. Administração e Fazenda", 0],  // 10-05-18 wil
    ["VILMAR JOSÉ NECKEL MARIA MADALENA SILVEIRA[^\\p]Prefeito Municipal Responsável Sec. Mun. Adm. e Fazenda", "VILMAR JOSÉ NECKEL \rPrefeito Municipal \r \rMARIA MADALENA SILVEIRA \rResponsável Sec. Mun. Administração e Fazenda", 0],  // 10-05-18 wil
    ["VILMAR JOSÉ NECKEL MARIA MADALENA SILVEIRA[^\\p]Prefeito Municipal Resp. Sec. Mun. Adm. e Fazenda", "VILMAR JOSÉ NECKEL \rPrefeito Municipal \r \rMARIA MADALENA SILVEIRA \rResponsável Sec. Mun. Administração e Fazenda", 0],  // 10-05-18 wil
    ["VILMAR JOSÉ NECKEL MARIA MADALENA SILVEIRA[^\\p]Prefeito Municipal Resp. Sec. Mun. Administração e Fazenda", "VILMAR JOSÉ NECKEL \rPrefeito Municipal \r \rMARIA MADALENA SILVEIRA \rResponsável Sec. Mun. Administração e Fazenda", 0],  // 10-05-18 wil
    ["1([0-9])(\\.)?\\r\\r([^\\r]+)\\r(Prefeit|PREFEIT|President|PRESIDENT|Diretor|DIRETOR)", 
     "1$1$2\\r$3\\r$4", 0], //2015-06-12 wdl GREP Pref ,Pres, Dir 
    ["(OSVALDO JURCK|ELISEU MIBACH|ADRIANO KATH)[ ]+([^\\r|^\\t]+)[\\r]+(Prefeit[^\\r]+)[ ]+(Secr|President|PRESIDENT|Diretor|DIRETOR|Diretor)", 
     "$1 \\t\\t\\t $2 \\r$3 \\t\\t $4", 0], //2019-12-02 GREP Pref Secre Diretor Pres  - DUAS Colunas
    ...
    ["(LILIAN BITTENCOURT CHÜLER)\\r\\r(Diretora Dpto Recursos HumanosDiretora Dpto Recursos Humanos)",
     "$1\\r$2", 0], // 10-05-18 wil
    ...
    ["(VILSON ANTONIO VERONA)\\r\\r(Prefeito em Exercício)", 
     "$1\\r$2", 0], // 10-05-18 wil
    
    ["(VILSON ANTONIO VERONA) (LILIAN BITTENCOURT CHÜLER)\\r\\r(Prefeito em Exercício) \\t(Diretora Dpto Recursos Humanos)",
    "$1\\r$3\\r\\r$2\\r$4", 0], // 10-05-18 wil

    ["(VILMAR JOSÉ NECKEL) (MARIA MADALENA SILVEIRA)\\r\\r(Prefeito Municipal) \\t(Responsável Sec. Mun. Administração e Fazenda)",
    "$1\\r$3\\r\\r$2\\r$4", 0], // 10-05-18 wil    
    
    
    ["(VILMAR JOSÉ NECKEL) (MARIA MADALENA SILVEIRA)\\r\\r(Prefeito Municipal) \\t(Responsável Sec. Mun. Adm. e Fazenda)",
    "$1\\r$3\\r\\r$2\\r$4", 0], // 10-05-18 wil    
    
    ["(VILMAR JOSÉ NECKEL) (MARIA MADALENA SILVEIRA)\\r\\r(Prefeito Municipal) \\t(Resp. Sec. Mun. Adm. e Fazenda)",
    "$1\\r$3\\r\\r$2\\r$4", 0], // 10-05-18 wil    
