...
if(printDebug) $.writeln("ImportarSeloAssDigDOMSC.jsx : var rootFolder: " + rootFolder);
var img_selo_ass =  '/Logos/assinatura-digital-dom.pdf';
...
function myPlacePDF(myDocument,myPage, myPDFFile){
   if(printDebug)  $.writeln("ImportarSeloAssDigDOMSC.jsx : myPlacePDF.myDocument: " + myDocument);
   if(printDebug)  $.writeln("ImportarSeloAssDigDOMSC.jsx : myPlacePDF.myPDFFile: " + myPDFFile);
