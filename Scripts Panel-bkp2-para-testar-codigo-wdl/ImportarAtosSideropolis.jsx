...
//    ["^(.{10,30})[ \\t]{3,}()$" , "$1\\x08",0] , // troca espaços consecutivos por uma tab de alinhamento a direita (para assinaturas na mesma linha)
    ...
    //["[ \\t]+$" , "",0+", "\\r\\r",0], 
    // ["\\r[ \\t\\r]+\\r] , // remove espaços consecutivos no fim do parágrafo
	// ["\\r\\r[ \\t\\r]", "\\r\\r",0] ,
    //["([ ]+\\r|\\r[\\t]+)", "\\r",0] ,
    // ["\\r[ \\t]+","\\r",0],
...
var regrasDOMSC = [
    ...
    ["VILSON ANTONIO VERONA LILIAN BITTENCOURT CHÜLER[^\\p]Prefeito em Exercício Diretora Dpto Recursos Humanos", "VILSON ANTONIO VERONA \rPrefeito em Exercício \r \rLILIAN BITTENCOURT CHÜLER \rDiretora Dpto Recursos Humanos", 0],  // 10-05-18 wil
    ["VILSON ANTONIO VERONA LILIAN BITTENCOURT CHÜLER[^\\p]Prefeito em Exercício Diretora do Dpto Recursos Humanos", "VILSON ANTONIO VERONA \rPrefeito em Exercício \r \rLILIAN BITTENCOURT CHÜLER \rDiretora Dpto Recursos Humanos", 0],   // 10-05-18 wil
